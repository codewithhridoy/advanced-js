...
const startESlintMarker = '<!--START_SECTION:eslint-config-->'
const endESlintMarker = '<!--END_SECTION:eslint-config-->'

const startPrettierMarker = '<!--START_SECTION:prettier-config-->'
const endPrettierMarker = '<!--END_SECTION:prettier-config-->'
